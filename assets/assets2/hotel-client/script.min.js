        ...
        $("#theadmin-search input").typeahead(null, {
            ...
            templates: {
                suggestion: function (a) {
                    return '<a href="' + location.origin + "/theadmin/empty/" + a.url + '"><h6 class="mb-1">' + a.title + "</h6><small>" + a.description + "</small></a>"
                }
            }
        }), $("#theadmin-search input").bind("typeahead:select", function (a, b) {
            window.location.href = location.origin + "/theadmin/empty/" + b.url
